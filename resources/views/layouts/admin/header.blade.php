  ...
  <div class="d-flex" id="wrapper">
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="{{route('productfrom')}}" class="list-group-item list-group-item-action bg-light">Product</a>
        <a href="{{route('categoryfrom')}}"class="list-group-item list-group-item-action bg-light">Category</a>
